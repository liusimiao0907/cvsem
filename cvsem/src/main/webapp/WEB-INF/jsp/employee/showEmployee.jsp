                    ...
                    <c:forEach  items="${employeelist}" var="item">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='${pageContext.request.contextPath}/employee/removeEmployee?id=${item.ID}'">删除</button>
                                <!--弹出框-->
                            </td>
                        </tr>
                    </c:forEach>
